        ...
        {trip.cover_image && (
          <div
            style={{
              position: 'absolute',
              inset: 0,
              backgroundImage: `url(${trip.cover_image.startsWith('http') ? trip.cover_image : apiUrl(trip.cover_image.startsWith('/') ? trip.cover_image : '/uploads/' + trip.cover_image)})`, // guard-gap: already apiUrl()-wrapped; the guard's stripper only matches a literal directly after apiUrl(, not this ternary
